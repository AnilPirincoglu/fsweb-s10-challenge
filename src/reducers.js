...
const minnetReducer = (
  ...
  switch (action.type) {
    case NOT_EKLE:
      const ekleState = { ...state, notlar: [...state.notlar, action.payload] };
      localStorageStateYaz(s10chLocalStorageKey, ekleState);
      return ekleState;
    case NOT_SIL:
      const silState = {
        ...state,
      ...
      localStorageStateYaz(s10chLocalStorageKey, silState);
      return silState;
    default:
      return state;
  }
